...
The plot “Total number of orders placed by day of the week” displays the
total number of orders placed by the day of the week. From this table,
we see that the most orders are placed on Sundays, followed by Mondays
and Saturdays. The fewest orders are placed on Wednesdays.
...
Data Cleaning Steps: *Format the data to use appropriate variable names;
...
dataset. The dataset includes data over 35 days (5 weeks). The dataset
also indicates the day of the week that the measurements come from.
There are 1,440 “minute” variables that include the accelerometer data
by minute over a 24 hour period. Lastly, there is a newly added variable
day\_class that indicates if the day of the week is a weekday or a
weekend.
...
not very variable on Wednesdays.
